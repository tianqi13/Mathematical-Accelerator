...
VL_ATTR_COLD void Vtop_level___024root__trace_init_sub__TOP__0(Vtop_level___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+9,"enable", false,-1);
    tracep->declBit(c+10,"rst", false,-1);
    tracep->declBus(c+11,"RGB_out", false,-1, 14,0);
    tracep->declBus(c+12,"X", false,-1, 9,0);
    tracep->declBus(c+13,"Y", false,-1, 9,0);
    ...
    tracep->declBus(c+12,"X", false,-1, 9,0);
    tracep->declBus(c+13,"Y", false,-1, 9,0);
    tracep->declBus(c+1,"count_out", false,-1, 14,0);
    tracep->declBit(c+2,"ovf", false,-1);
    tracep->declBus(c+3,"x", false,-1, 9,0);
    tracep->declBus(c+4,"y", false,-1, 9,0);
    tracep->declBus(c+5,"rd_addr", false,-1, 19,0);
    tracep->pushNamePrefix("addr_counter ");
    tracep->declBit(c+8,"clk", false,-1);
    tracep->declBit(c+2,"en", false,-1);
    tracep->declBit(c+10,"rst", false,-1);
    tracep->declBus(c+5,"addr_count", false,-1, 19,0);
    tracep->declBus(c+12,"X", false,-1, 9,0);
    tracep->declBus(c+13,"Y", false,-1, 9,0);
    ...
    tracep->declBus(c+1,"Count", false,-1, 14,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+5,"rd_addr", false,-1, 19,0);
    tracep->declBus(c+7,"wr_addr", false,-1, 19,0);
    tracep->declBus(c+1,"din", false,-1, 14,0);
    tracep->declBus(c+11,"RGB", false,-1, 14,0);
...
VL_ATTR_COLD void Vtop_level___024root__trace_full_sub_0(Vtop_level___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullSData(oldp+1,(vlSelf->top_level__DOT__count_out),15);
    bufp->fullBit(oldp+2,(vlSelf->top_level__DOT__ovf));
    bufp->fullSData(oldp+3,(vlSelf->top_level__DOT__x),10);
    bufp->fullSData(oldp+4,(vlSelf->top_level__DOT__y),10);
    bufp->fullIData(oldp+5,(vlSelf->top_level__DOT__rd_addr),20);
    bufp->fullBit(oldp+6,((1U & (~ (IData)(vlSelf->top_level__DOT__ovf)))));
    bufp->fullIData(oldp+7,((((IData)(vlSelf->top_level__DOT__y) 
    ...
    bufp->fullSData(oldp+11,(vlSelf->RGB_out),15);
    bufp->fullSData(oldp+12,(vlSelf->X),10);
    bufp->fullSData(oldp+13,(vlSelf->Y),10);
    bufp->fullIData(oldp+14,(0x14U),32);
    bufp->fullIData(oldp+15,(0xfU),32);
}
