...
VL_ATTR_COLD void Vmandelbrot_toplevel___024root___settle__TOP__0(Vmandelbrot_toplevel___024root* vlSelf) {
    ...
    vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__muxout2 
        = ((IData)(vlSelf->mandelbrot_toplevel__DOT__or_out)
            ? 0U : vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__s2);
    ...
    vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__muxout1 
        = ((IData)(vlSelf->mandelbrot_toplevel__DOT__or_out)
            ? 0U : vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__s1);
}
...
VL_ATTR_COLD void Vmandelbrot_toplevel___024root___ctor_var_reset(Vmandelbrot_toplevel___024root* vlSelf) {
    ...
    vlSelf->mandelbrot_toplevel__DOT__x_internal = VL_RAND_RESET_I(32);
    vlSelf->mandelbrot_toplevel__DOT__y_internal = VL_RAND_RESET_I(32);
    ...
    vlSelf->mandelbrot_toplevel__DOT__out = VL_RAND_RESET_I(15);
    vlSelf->mandelbrot_toplevel__DOT__ovf_it = VL_RAND_RESET_I(1);
    vlSelf->mandelbrot_toplevel__DOT__or_out = VL_RAND_RESET_I(1);
    vlSelf->mandelbrot_toplevel__DOT____Vcellinp__Mapper__en = VL_RAND_RESET_I(1);
    vlSelf->mandelbrot_toplevel__DOT__rd_addr = VL_RAND_RESET_I(20);
    vlSelf->mandelbrot_toplevel__DOT____Vcellout__addr_counter__Y = VL_RAND_RESET_I(10);
    vlSelf->mandelbrot_toplevel__DOT____Vcellout__addr_counter__X = VL_RAND_RESET_I(10);
    ...
    vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__GENERATOR__DOT__X = VL_RAND_RESET_I(1);
    vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__GENERATOR__DOT__delta = VL_RAND_RESET_I(1);
    ...
    vlSelf->__Vdly__mandelbrot_toplevel__DOT__counter_mod__DOT__counter_reg = VL_RAND_RESET_I(15);
    vlSelf->__VinpClk__TOP__mandelbrot_toplevel__DOT__or_out = VL_RAND_RESET_I(1);
    vlSelf->__Vchglast__TOP__mandelbrot_toplevel__DOT__or_out = VL_RAND_RESET_I(1);
