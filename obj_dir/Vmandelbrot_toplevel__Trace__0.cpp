...
void Vmandelbrot_toplevel___024root__trace_chg_sub_0(Vmandelbrot_toplevel___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,(vlSelf->mandelbrot_toplevel__DOT__Mapper__DOT__Y),10);
        bufp->chgBit(oldp+1,(vlSelf->mandelbrot_toplevel__DOT__ovf));
        bufp->chgBit(oldp+2,(vlSelf->mandelbrot_toplevel__DOT__q));
        bufp->chgBit(oldp+3,(vlSelf->mandelbrot_toplevel__DOT__q_bar));
        bufp->chgSData(oldp+4,(vlSelf->mandelbrot_toplevel__DOT__counter_out),15);
        bufp->chgBit(oldp+5,(vlSelf->mandelbrot_toplevel__DOT__ovf_it));
        bufp->chgIData(oldp+6,(vlSelf->mandelbrot_toplevel__DOT__rd_addr),20);
        bufp->chgIData(oldp+7,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A),32);
        bufp->chgIData(oldp+8,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B),32);
        ...
        bufp->chgIData(oldp+10,(((IData)((((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A)) 
                                 ...
                                 - (IData)((((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B)) 
                                             * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B))) 
                                            >> 0x15U)))),32);
        bufp->chgIData(oldp+11,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__twoab),32);
        ...
        bufp->chgIData(oldp+13,((IData)((((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B)) 
                                          * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B))) 
                                         >> 0x15U))),32);
        bufp->chgIData(oldp+14,((IData)((((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A)) 
                                          * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B))) 
                                         >> 0x15U))),32);
        bufp->chgIData(oldp+15,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__GENERATOR__DOT__ab_truncated),31);
        bufp->chgQData(oldp+16,(((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A)) 
                                 * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A)))),64);
        bufp->chgQData(oldp+18,(((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__A)) 
                                 * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B)))),64);
        bufp->chgQData(oldp+20,(((QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B)) 
                                 * (QData)((IData)(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__B)))),64);
        bufp->chgSData(oldp+22,(vlSelf->mandelbrot_toplevel__DOT__Mapper__DOT__X),10);
        ...
        bufp->chgIData(oldp+27,((0xfffffU & (((IData)(vlSelf->mandelbrot_toplevel__DOT__Mapper__DOT__Y) 
                                              << 0xaU) 
                                             | (IData)(vlSelf->mandelbrot_toplevel__DOT__Mapper__DOT__Y)))),20);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+28,(vlSelf->mandelbrot_toplevel__DOT__real_internal),32);
        bufp->chgBit(oldp+29,(vlSelf->mandelbrot_toplevel__DOT__or_out));
        bufp->chgBit(oldp+30,((0x800000U < vlSelf->mandelbrot_toplevel__DOT__real_internal)));
        bufp->chgIData(oldp+31,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__s1),32);
        bufp->chgIData(oldp+32,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__s2),32);
        bufp->chgIData(oldp+33,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__muxout1),32);
        bufp->chgIData(oldp+34,(vlSelf->mandelbrot_toplevel__DOT__DIVERGE__DOT__muxout2),32);
    }
    bufp->chgBit(oldp+35,(vlSelf->rst));
    bufp->chgBit(oldp+36,(vlSelf->clk));
    bufp->chgBit(oldp+37,(vlSelf->enable));
    bufp->chgSData(oldp+38,(vlSelf->x_size),10);
    bufp->chgSData(oldp+39,(vlSelf->y_size),10);
    bufp->chgIData(oldp+40,(vlSelf->Re_axis_width),32);
    bufp->chgIData(oldp+41,(vlSelf->Im_axis_width),32);
    bufp->chgSData(oldp+42,(vlSelf->RGB_out),15);
    bufp->chgSData(oldp+43,(vlSelf->X),10);
    bufp->chgSData(oldp+44,(vlSelf->Y),10);
    bufp->chgIData(oldp+45,(VL_DIV_III(32, vlSelf->Re_axis_width, (IData)(vlSelf->x_size))),32);
    bufp->chgIData(oldp+46,(VL_DIV_III(32, vlSelf->Im_axis_width, (IData)(vlSelf->y_size))),32);
    bufp->chgIData(oldp+47,(((IData)((((QData)((IData)(
    ...
    bufp->chgBit(oldp+48,((((IData)(vlSelf->enable) 
