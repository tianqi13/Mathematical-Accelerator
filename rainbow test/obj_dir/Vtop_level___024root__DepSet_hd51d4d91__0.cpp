...
VL_INLINE_OPT void Vtop_level___024root___nba_sequent__TOP__0(Vtop_level___024root* vlSelf) {
    ...
    vlSelf->__Vdly__top_level__DOT__y = vlSelf->top_level__DOT__y;
    vlSelf->__Vdly__top_level__DOT__x = vlSelf->top_level__DOT__x;
...
VL_INLINE_OPT void Vtop_level___024root___nba_sequent__TOP__1(Vtop_level___024root* vlSelf) {
    ...
    } else if ((0xfffffU == vlSelf->top_level__DOT__rd_addr)) {
        __Vdly__top_level__DOT__rd_addr = 0U;
...
VL_INLINE_OPT void Vtop_level___024root___nba_sequent__TOP__2(Vtop_level___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->rst) {
        vlSelf->__Vdly__top_level__DOT__x = 0U;
        vlSelf->__Vdly__top_level__DOT__y = 0U;
        ...
        if ((0x3ffU == (IData)(vlSelf->top_level__DOT__x))) {
            ...
            vlSelf->__Vdly__top_level__DOT__x = 0U;
            vlSelf->__Vdly__top_level__DOT__y = (0x3ffU 
                                                 & ((IData)(1U) 
                                                    + (IData)(vlSelf->top_level__DOT__y)));
        } else {
            vlSelf->__Vdly__top_level__DOT__x = (0x3ffU 
                                                 & ((IData)(1U) 
                                                    + (IData)(vlSelf->top_level__DOT__x)));
        }
    }
    vlSelf->top_level__DOT__x = vlSelf->__Vdly__top_level__DOT__x;
    vlSelf->top_level__DOT__y = vlSelf->__Vdly__top_level__DOT__y;
}
